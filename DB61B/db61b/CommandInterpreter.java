...
class CommandInterpreter {
    ...
    void loadStatement() {
        _input.next("load");
        String theName = name();
        Table loadedTable = Table.readTable(theName);
        _database.put(theName, loadedTable);
        System.out.println("Loaded " + theName + ".db");
        _input.next(";");
    }
