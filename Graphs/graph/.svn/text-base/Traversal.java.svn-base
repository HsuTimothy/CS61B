...
public abstract class Traversal {
    ...
    public void traverse(Collection<Integer> V0) {
        ...
        while (!(_fringe.isEmpty())) {
            ...
            if (!marked(v)) {
                ...
                for (Integer e : _G.successors(v)) {
                    if (processSuccessor(v, e)) {
                        _fringe.add(e);
                    }
                }
    ...
    protected ArrayList<Integer> _visited = new ArrayList<Integer>();
    /** Stores marked vertices. */
    protected ArrayList<Integer> _marker = new ArrayList<Integer>();
